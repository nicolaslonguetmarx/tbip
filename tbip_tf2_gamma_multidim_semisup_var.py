...
def build_input_pipeline(data_dir,
  ...
  vocabulary = np.loadtxt(os.path.join(data_dir, "vocabulary.txt"),
                          ...
                          delimiter="\n",
                          comments="<!-")
  return dataset, vocabulary, author_map,  num_documents, num_words, initial_ideal_points, variance_priors
...
def main(argv):
  ...
  (dataset, vocabulary, author_map,
   num_documents, num_words, initial_ideal_points, variance_priors) = build_input_pipeline(
      data_dir,
      FLAGS.batch_size,
      random_state,
